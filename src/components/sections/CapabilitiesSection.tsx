...
export function CapabilitiesSection() {
  ...
  return <section ref={sectionRef} className="py-32 lg:py-40 bg-secondary relative overflow-hidden">
      {/* Background */}
      <div className="absolute inset-0 grid-pattern opacity-10 bg-primary-foreground" />
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        once: true
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
            ...
            <span className="text-gradient font-serif text-6xl">Clients Say</span>
          </h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {testimonials.slice(0, 6).map((testimonial, index) => <motion.div key={testimonial.author} initial={{
          opacity: 0,
          y: 30
        }} whileInView={{
          opacity: 1,
        ...
        once: true
          ...
          <div className="relative rounded-3xl overflow-hidden">
            ...
            <div className="relative flex flex-col lg:flex-row items-center justify-between gap-8 p-12 lg:p-16">
              ...
              <Button asChild size="lg" className="btn-gradient rounded-xl group whitespace-nowrap">
